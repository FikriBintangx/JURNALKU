...
import { SearchResponse, Journal } from '@/types/journal';
...
export const journalService = {
  async search(query: string, limit: number = 10, offset: number = 0, provider: string = 'default'): Promise<SearchResponse> {
    try {
